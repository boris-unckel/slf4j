...
/**
 * Work from https://github.com/apache/logging-log4j2/blob/release-2.x/log4j-api/src/main/java/org/apache/logging/log4j/util/LoaderUtil.java
 *
...
final class LoaderUtil {
     ...
     public static boolean isClassAvailable(final String className) {
          try {
               ...
               Util.report("Unknown error checking for existence of class: " + className, e);
               return false;
          }
     }
          ...
          for (final ClassLoader cl : candidates) {
               if (cl != null) {
                    try {
                         ...
                         Util.report("Can't load resource " +  resource, e);
                    }
               }
          }
          return resources;
